...
import 'package:riverpodtest/features/emojis/presentation/screens/emojis_screen.dart';

class EmojisLocation extends BeamLocation<BeamState> {
  EmojisLocation(RouteInformation routeInformation) : super(routeInformation);
